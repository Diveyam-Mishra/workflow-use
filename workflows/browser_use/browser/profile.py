...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	def detect_display_configuration(self) -> None:
		...
		if self.viewport is None and self.window_size is None:
			self.viewport = ViewportSize(width=1280, height=720)
			logger.info(f"No viewport or window_size specified, defaulting to viewport {self.viewport['width']}x{self.viewport['height']} for consistency.")
